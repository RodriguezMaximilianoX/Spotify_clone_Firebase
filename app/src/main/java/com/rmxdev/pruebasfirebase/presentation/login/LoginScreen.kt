package com.rmxdev.pruebasfirebase.presentation.login
...
@Composable
fun LoginScreen(modifier: Modifier = Modifier, auth: FirebaseAuth, navigateToHome: () -> Unit) {
